...
public class TedPermissionActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_PERMISSIONS = "권한";
    public static final String EXTRA_RATIONALE_MESSAGE = "권한 필요";
    public static final String EXTRA_DENY_MESSAGE = "권한이 거부되었습니다.";
    public static final String EXTRA_PACKAGE_NAME = "하프라인";
    public static final String EXTRA_SETTING_BUTTON = "설정";
    public static final String EXTRA_RATIONALE_CONFIRM_TEXT = "접근 권한이 필요합니다";
    public static final String EXTRA_DENIED_DIALOG_CLOSE_TEXT = "권한을 허용하셔야 서비스 이용이 가능합니다.";
